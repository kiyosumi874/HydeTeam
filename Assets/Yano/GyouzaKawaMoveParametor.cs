...
{
    [SerializeField][Header("ˆÚ“®‚µ‚È‚ª‚ç‹È‚ª‚é—Ê")][Range(1.0f,180.0f)] private float setAddRad;
    public float addRad { get => setAddRad; }
    [SerializeField][Header("ˆÚ“®—Ê")][Range(0.1f, 10.0f)] private float setMovePower;
    ...
    [SerializeField][Header("ˆÚ“®‚Ì‰ÁŽZ—Ê")][Range(0.0f, 10.0f)] private float setAddMovePower;
