...
public class NewMeetGenerator : MonoBehaviour
{
    //変数宣言
    ...
    [SerializeField]
    private Transform createPosition;    // 肉だねを生成する座標
    ...
    void Update()
    {
        ...
        if (TapBottan && deltatime >= span)　//spanとdeltatimeで落とす間隔を制御する
        {
            ...
            //コピーした肉だねの設定
            C_Meat.transform.position = new Vector2(createPosition.position.x, createPosition.position.y); //場所
